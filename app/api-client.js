...
const MobileAPI = {
  ...
  updateJobPosting(id, body) { return this.request(`/api/job-postings?id=${id}`, { method: "PATCH", body: JSON.stringify(body) }); },
  deleteJobPosting(id) { return this.request(`/api/job-postings?id=${id}`, { method: "DELETE" }); },
